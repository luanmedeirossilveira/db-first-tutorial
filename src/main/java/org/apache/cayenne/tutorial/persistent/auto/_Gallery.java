...
public abstract class _Gallery extends BaseDataObject {
    ...
    public static final Property<LocalDate> FOUNDED_DATE = Property.create("foundedDate", LocalDate.class);
    ...
    protected void writeState(ObjectOutputStream out) throws IOException {
        ...
        out.writeObject(this.foundedDate);
    ...
    protected void readState(ObjectInputStream in) throws IOException, ClassNotFoundException {
        super.readState(in);
        this.foundedDate = (LocalDate)in.readObject();
